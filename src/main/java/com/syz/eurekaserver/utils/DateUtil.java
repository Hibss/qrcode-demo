...
public class DateUtil {
    ...
    private static final ThreadLocal<DateFormat> FORMAT_MILLISECOND = new ThreadLocal<DateFormat>(){

    };

    public static String getCurrentDate(String aFormat) {
        SimpleDateFormat sdf = getSdf(aFormat);
        String tDate = sdf.format(new Date(System.currentTimeMillis()));
        return tDate;
    }
    ...
    public static Integer getCurrentDateInt() {
        return Integer.parseInt(DateUtil.getCurrentDate("yyyyMMdd"));
    }
    ...
    public static String getCurrentDateAndMilliSecond() {
    ...
    public static String currentTimeSeconds(Date date) {
        return time2str(date,"yyyyMMddHHmmss");
    }
